    ...
    <div class="page-wrapper bg-gra-02 p-t-130 p-b-100 font-poppins">
        <div class="wrapper wrapper--w680">
            <div class="card card-4">
                <div class="card-body">
                    <h2 class="title">COURSE UPDATE FORM</h2>
                    ...
                    <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <f:input path="cId"  readonly="true" class="input--style-4" /> 
                                </div>
                            </div>
                        </div>
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <f:input path="cName" readonly="true" class="input--style-4" /> <f:errors path="cName"/>
                                </div>
                            </div>
                        </div>
                         <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <f:input path="cDuration" readonly="true" class="input--style-4" /> <f:errors path="cDuration"/>
                                </div>
                            </div>
                        </div>
                        <div class="row row-space">
                        ...
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <f:input path="cSeats" readonly="true" class="input--style-4" /> <f:errors path="cSeats"/>
                                </div>
                            </div>
                        </div>
