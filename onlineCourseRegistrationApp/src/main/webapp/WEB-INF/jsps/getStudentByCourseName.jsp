...
<!-- Title Page-->
<title>Student By CourseName</title>
		...
		<div class="page-wrapper bg-gra-02 p-t-130 p-b-100 font-poppins">
			<div class="wrapper wrapper--w680">
				<div class="card card-4">
					<div class="card-body">
                       <h2 class="title">GETTING STUDENT BY COURSE NAME</h2>
                       <form action="studentByCourse" method="post">
							<div class="row row-space">
								<div class="col-2">
									<div class="input-group">
                                       <label class="label">Enter Course Name:</label>
                                       <input type="text" name="courseName" class="input--style-4">
                                    </div>
								</div>
							</div>
							<div class="p-t-15">
